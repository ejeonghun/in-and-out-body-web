...
from analysis.swagger import login_mobile_, login_mobile_id_pw_, login_mobile_uuid_, delete_user_, get_user_, get_code_, get_gait_result_, login_mobile_qr_, get_body_result_, get_body_result_id_, delete_gait_result_, delete_body_result_, mobile_body_sync_
